...
namespace MarriageBureau.Services
{
    ...
    public static class ExcelExportService
    {
        ...
        private static readonly (string Header, Func<Biodata, string?> Getter)[] Columns =
        {
            ...
            ("DESIGNATION DETAILS (NAME & PLACE)", b => b.DesignationDetails),
            ("INCOME",                b => b.Income),
            ("ASSET VALUE",           b => b.AssetValue),
            ("GIFT",                  b => b.Gift),
            ...
            ("BROTHER DETAILS",       b => b.BrotherDetails),
            ("SISTER",                b => b.SisterCount),
            ("SISTER DETAILS",        b => b.SisterDetails),
            ...
            ("PH NO.1",               b => b.Phone1),
            ("PH NO.2",               b => b.Phone2),
            ("REFERENCE NAME",        b => b.References),
            ("REFERENCE PHONE",       b => b.ReferencePhone),
            ("EXPECTATIONS FROM PARTNER", b => b.ExpectationsFromPartner),
            ("PREFERENCES",           b => b.Preferences),
        };
